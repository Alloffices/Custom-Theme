...
<html>
    ...
    <body data-spy="scroll" data-target="#navbar-scroll">
        ...
        <div class="fullscreen landing parallax" style="background-image:url('<?php esc_attr_e("$images_dir/bg.jpg"); ?>');" data-img-width="2000" data-img-height="1333" data-diff="100">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-7">
                            ...
                            <!-- /.logo -->
                            <div class="logo wow fadeInDown"> <a href=""><img src="<?php esc_attr_e("$images_dir/logo.png"); ?>" alt="logo"></a></div>
            ...
            <nav class="navbar-wrapper navbar-default" role="navigation">
                <div class="container">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand site-name" href="#top"><img src="<?php esc_attr_e("$images_dir/logo2.png"); ?>" alt="logo"></a>
                    </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6 intro-pic wow slideInLeft">
                        <img src="<?php esc_attr_e("$images_dir/intro-image.jpg"); ?>" alt="image" class="img-responsive">
                    </div>
                ...
                <div class="row row-feat">
                    <div class="col-md-4 text-center">
                        ...
                        <div class="feature-img">
                            <img src="<?php esc_attr_e("$images_dir/feature-image.jpg"); ?>" alt="image" class="img-responsive wow fadeInLeft">
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6 feature-2-pic wow fadeInRight">
                        <img src="<?php esc_attr_e("$images_dir/feature2-image.jpg"); ?>" alt="macbook" class="img-responsive">
                    </div>
                </div>
        ...
        <!-- /.download section -->
        <div id="download">
            <div class="action fullscreen parallax" style="background-image:url('<?php esc_attr_e("$images_dir/bg.jpg"); ?>');" data-img-width="2000" data-img-height="1333" data-diff="100">
                <div class="overlay">
                    <div class="container">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-12 text-center">
                        <img alt="client" src="<?php esc_attr_e("$images_dir/client1.png"); ?>" class="wow fadeInUp">
                        <img alt="client" src="<?php esc_attr_e("$images_dir/client2.png"); ?>" class="wow fadeInUp" data-wow-delay="0.2s">
                        <img alt="client" src="<?php esc_attr_e("$images_dir/client3.png"); ?>" class="wow fadeInUp" data-wow-delay="0.4s">
                        <img alt="client" src="<?php esc_attr_e("$images_dir/client4.png"); ?>" class="wow fadeInUp" data-wow-delay="0.6s">
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div id="owl-testi" class="owl-carousel owl-theme wow fadeInUp">
                            ...
                            <div class="testi-item">
                                <div class="client-pic text-center">
                                    ...
                                    <!-- /.client photo -->
                                    <img src="<?php esc_attr_e("$images_dir/testi1.png"); ?>" alt="client">
                                </div>
                                <div class="box">
                            ...
                            <div class="testi-item">
                                <div class="client-pic text-center">
                                    ...
                                    <!-- /.client photo -->
                                    <img src="<?php esc_attr_e("$images_dir/testi2.png"); ?>" alt="client">
                                </div>
                                <div class="box">
                            ...
                            <div class="testi-item">
                                <div class="client-pic text-center">
                                    ...
                                    <!-- /.client photo -->
                                    <img src="<?php esc_attr_e("$images_dir/testi3.png"); ?>" alt="client">
                                </div>
                                <div class="box">
        ...
        <!-- /.contact section -->
        <div id="contact">
            <div class="contact fullscreen parallax" style="background-image:url('<?php esc_attr_e("$images_dir/bg.jpg"); ?>');" data-img-width="2000" data-img-height="1334" data-diff="100">
                <div class="overlay">
                    <div class="container">
